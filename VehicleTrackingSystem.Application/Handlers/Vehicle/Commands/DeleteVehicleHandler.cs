...
{
    public class DeleteVehicleHandler : IRequestHandler<DeleteVehicle, Result>
    {
        ...
        public async Task<Result> Handle(DeleteVehicle request, CancellationToken cancellationToken)
        {
